...
function consoleReport (jsonReport) {
  ...
  log.red(unused(jsonReport.declarations, jsonReport.dependencies));
}

function fileReport (jsonReport) {
  ...
  fileContent += '\n[ Unused dependencies ]\n';
  fileContent += unused(jsonReport.declarations, jsonReport.dependencies);
