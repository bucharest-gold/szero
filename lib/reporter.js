...
function unused (declarations, dependencies) {
  ...
  return unusedArray.length ? unusedArray : 'None.';
}

function jsonReporter (result, dependencies) {
  console.log('jsonreporter', result, dependencies);
...
function report (result, dependencies) {
  console.log('report', result, 'report', dependencies);
...
function fileReport (result, dependencies) {
  console.log('result 1', result, 'dep 1', dependencies);
  const jsonReport = jsonReporter(result, dependencies);
  console.log(result, dependencies, jsonReport);
